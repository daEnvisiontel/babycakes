...
/**
 * Template Name: Blog Grid/Masonry
 *
 * The blog page template displays the "blog-grid" masonry template on a sub-page. 
 *
...
?>
    <!-- #content Starts -->
    <div id="content" class="col-full blog-masonry">
