...
if (!class_exists('VcTableManager')) {
    Class VcTableManager
    {
                ...
                "params" => array(
                    array(
                        ...
                        "value" => array(
                            ...
                            __("Classic Brown", "vc_table_manager") => "classic_brown",
                            ...
                            __("Simple Brown", "vc_table_manager") => "simple_brown"
                       ),
                    ),
                    array(
                        "type" => $param_name,
        ...
        {
		   $vctturl = get_template_directory_uri() . '/includes/tt-vc-extend/easy-tables-vc'; // added by tt for global access.
           return $vctturl . '/assets/' . $file;
        }
        ...
        {
            wp_register_script('vc_jquery_handsontable', $this->assetURL('lib/jquery-handsontable/dist/jquery.handsontable.full.js'), array('jquery'), '', true);
            wp_register_script('vc_plugin_table', $this->assetURL('js/table.js'), array('wpb_js_composer_js_custom_views', 'vc_jquery_handsontable'), '', true);
            wp_enqueue_script('vc_plugin_table');
            wp_register_script('vc_bootstrap_dropdown', $this->assetURL('lib/bootstrap-dropdown/bootstrap.js'), array('wpb_js_composer_js_custom_views', 'vc_jquery_handsontable'), '', true);
            wp_enqueue_script('vc_bootstrap_dropdown');
            wp_localize_script( 'wpb_js_composer_js_view', 'i18nVcTable', array(
            ...
            wp_register_style('vc_jquery_handsontable_css', $this->assetURL('lib/jquery-handsontable/dist/jquery.handsontable.css'), false);
            wp_register_style('vc_plugin_table_admin_css', $this->assetURL('css/admin.css'), array('vc_jquery_handsontable_css'), '1.0.0');
