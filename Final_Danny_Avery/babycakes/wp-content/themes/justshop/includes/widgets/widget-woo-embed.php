...
class Woo_EmbedWidget extends WP_Widget {
	...
	function Woo_EmbedWidget() {
		...
		parent::WP_Widget( false, __( 'JS - Embed/Video', 'templatation' ), $widget_ops );
	}
...
<?php
	...
	function form( $instance ) {
		...
		?>
			<p>
				<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:','templatation'); ?></label>
				<input type="text" name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo esc_attr( $title ); ?>" class="widefat" id="<?php echo $this->get_field_id('title'); ?>" />
			</p>
			<p>
				<label for="<?php echo $this->get_field_id('cat_id'); ?>"><?php _e('Category:','templatation'); ?></label>
...
?>
			...
			<p>
				<label for="<?php echo $this->get_field_id('tag'); ?>">Or <?php _e('Tag:','templatation'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('width'); ?>"><?php _e('Size:','templatation'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('limit'); ?>"><?php _e('Limit (optional):','templatation'); ?></label>
