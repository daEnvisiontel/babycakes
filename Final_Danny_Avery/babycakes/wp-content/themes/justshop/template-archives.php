		...
		<section id="main" class="col-left">
			...
			<article <?php post_class(); ?>>
			    ...
			    <section class="entry fix">
		            ...
		            ?>
				    <h3><?php _e( 'The Last 30 Posts', 'templatation' ); ?></h3>
				    ...
				    <ul>											  
				        ...
				        ?>
				            ...
				            <li><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a> - <?php the_time( get_option( 'date_format' ) ); ?> - <?php echo $post->comment_count; ?> <?php _e( 'comments', 'templatation' ); ?></li>
				        <?php
				        		}
				        	}
				        	wp_reset_query();
					...
					<div id="archive-dates" class="fr" style="width:48%">												  
					    <h3><?php _e( 'Monthly Archives', 'templatation' ); ?></h3>
