<?php
$output = $title = $values = $units = $bgcolor = $custombgcolor = $options = $el_class = $tt_style = '';
...
if( $tt_style == "justshop" ) $tt_style = "ns_progress";

$output = '<div class="'.$tt_style.' templatation '.$css_class.'">';
$output .= wpb_widget_title(array('title' => $title, 'extraclass' => 'wpb_progress_bar_heading nt-underline'));
