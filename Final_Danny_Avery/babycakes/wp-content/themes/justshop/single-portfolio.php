			...
			<section id="main" class="fullwidth">
				...
				<?php
					...
					if ( $embed != '' ) {
						...
						if ( $featured_image_id != '' ) {
							...
							$html .= '<a href="' . $image_url . '" data-rel="' . $rel . '">' . woo_image( $args ) . '</a>' . "\n";
							$html .= '</div>';
						}
				...
				<article <?php post_class(); ?>>
	                ...
	                <section class="entry">
						...
						if ($custom_url != ''): ?><a class="button" href="<?php echo $custom_url ?>"><?php _e('View Project', 'templatation') ?></a><?php endif; ?>
	            ...
	            <div class="fix"></div><div class="woo-sc-divider"></div>
	            <?php
