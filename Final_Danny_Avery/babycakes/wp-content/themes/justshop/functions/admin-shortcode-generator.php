...
Description: templatation shortcode generator.
...
class templatation_Shortcode_Generator {
...
-----------------------------------------------------------------------------------*/
	...
	function templatation_Shortcode_Generator () {
	...
	} // End templatation_Shortcode_Generator()
...
-----------------------------------------------------------------------------------*/
	...
	function filter_mce_buttons( $buttons ) {
		...
		array_push( $buttons, '|', 'templatation_shortcodes_button' );
...
-----------------------------------------------------------------------------------*/
	...
	function filter_mce_external_plugins( $plugins ) {
        ...
        $plugins['templatationShortcodes'] = wp_nonce_url( esc_url( $this->framework_url() . 'js/shortcode-generator/editor_plugin.js' ), 'wooframework-shortcode-generator' );
...
$woo_shortcode_generator = new templatation_Shortcode_Generator();
?>