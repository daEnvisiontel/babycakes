/**
 * templatation Custom Fields JavaScript
 *
 ...
 */
  ...
  }; // End templatationCustomFields Object // Don't remove this, or the sky will fall on your head.

/**
 * Execute the above methods in the templatationCustomFields object.
 *
 * @since 4.8.0
 */
	$(document).ready(function () {
	
		templatationCustomFields.adjust_form_encoding();
		templatationCustomFields.setup_datepickers();
		templatationCustomFields.setup_timefields();
		templatationCustomFields.setup_wordcounters();
		templatationCustomFields.setup_image_selectors();
		templatationCustomFields.setup_colourpickers();
		templatationCustomFields.setup_upload_titletest();
		templatationCustomFields.setup_field_tabber();
