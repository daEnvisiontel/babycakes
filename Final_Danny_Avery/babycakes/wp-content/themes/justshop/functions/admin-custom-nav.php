...
- templatation Custom Navigation Setup
-- templatation Custom Navigation Setup
-- templatation Custom Navigation Menu Item
-- templatation Custom Navigation Scripts
- templatation Custom Navigation Interface
- templatation Custom Navigation Functions
...
function woo_custom_navigation_deprecation_notice( $function ) {
	trigger_error( sprintf( __( '%1$s is <strong>deprecated</strong> since version %2$s of the WooFramework! Use %3$s instead.', 'templatation' ), $function, '5.4', __( 'WordPress Menu Management', 'templatation' ) ) );
}

/*-----------------------------------------------------------------------------------*/
/* templatation Custom Navigation Menu Setup
/* Setup of the Menu
...
/*-----------------------------------------------------------------------------------*/
/* templatation Custom Navigation Menu Interface
